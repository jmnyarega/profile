    ...
    return <HeroSection>
        <IntroSection>
            <Heading1>Josiah is a
                <AccentHeading1> web designer </AccentHeading1> and <AccentHeading1> front-end
                    developer</AccentHeading1>
            </Heading1>
...
const Skills: React.FC<{ skills: SkillSet }> = ({skills}) => <section>
    <Spacer $size='2rem'/>
    ...
    <ul style={{lineHeight: "180%", color: "rgb(var(--white))", listStyleType: "' -> '", listStylePosition: "inside"}}>
        {Object.keys(skills).map((skill) => <li key={skill}>
